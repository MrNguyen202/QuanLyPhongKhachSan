...
public class App extends JFrame {
	...
	private MenuItem menuHomePage, menuDatPhong, menuDungDichVu, menuHoaDon, menuHoaDonThanhToan,
			menuHoaDonThanhToanSDDV, menuQuanLy, menuQLKHang, menuQLPhong, menuQLDVu, menuQLTNghi, menuQLNVien;
	private CardLayout cardLayout;
	private QuanLyThuePhong ql_ThuePhong;
	private QuanLyPhong ql_Phong;
	private ThanhToanDichVu hd_DichVu;
	private QuanLyNhanVien ql_NhanVien;
...
//	private NhanVien nv;
	private NhanVien nv;
	private GUI_DoiPass frmDoiPass;
	...
	public App(NhanVien nv) {
		...
		ql_Phong = new QuanLyPhong();
		hd_DichVu = new ThanhToanDichVu();
		ql_NhanVien = new QuanLyNhanVien();
		try {
		...
		mainPanel.add(ql_NhanVien, "Quản lý nhân viên");
		mainPanel.add(ql_Phong, "Quản lý phòng");
	...
	private void execute() {
		...
		menuHomePage = new MenuItem(iconHomePage, "Trang chủ", new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				menuQLPhong.setBackground(Color.white);
				menuQLDVu.setBackground(Color.white);
				menuQLTNghi.setBackground(Color.white);
				menuQLNVien.setBackground(Color.white);
		...
		// menu quản lý phòng
		menuQLPhong = new MenuItem(iconBill2, "Quản lý phòng", new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				menuQLPhong.setBackground(new Color(255, 195, 174));
				menuHoaDonThanhToan.setBackground(Color.white);
				menuHoaDonThanhToanSDDV.setBackground(Color.white);
				menuQLDVu.setBackground(Color.white);
				menuQLNVien.setBackground(Color.white);
				...
				cardLayout.show(mainPanel, "Quản lý phòng");
		...
		menuQLNVien = new MenuItem(iconBill2, "Quản lý nhân viên", new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				menuQLNVien.setBackground(new Color(255, 195, 174));
				menuHoaDonThanhToan.setBackground(Color.white);
				menuHoaDonThanhToanSDDV.setBackground(Color.white);
				menuQLKHang.setBackground(Color.white);
				menuQLTNghi.setBackground(Color.white);
				...
				cardLayout.show(mainPanel, "Quản lý nhân viên");
			}
		});
		...
		}, menuQLKHang, menuQLPhong, menuQLDVu, menuQLTNghi, menuQLNVien);
	...
	private void initComponents(NhanVien nv) {
		...
		panelHeaderLayout.setHorizontalGroup(panelHeaderLayout
				...
				.addGroup(panelHeaderLayout.createSequentialGroup().addGap(20, 20, 20)
				...
				.addGroup(panelHeaderLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(panelHeaderLayout.createSequentialGroup().addGap(501, 501, 501)
								.addComponent(jLabel8, javax.swing.GroupLayout.PREFERRED_SIZE, 709,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addContainerGap(142, Short.MAX_VALUE))));
		panelHeaderLayout.setVerticalGroup(panelHeaderLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(panelHeaderLayout.createSequentialGroup().addGap(18, 18, 18)
						.addGroup(panelHeaderLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addGroup(panelHeaderLayout.createSequentialGroup().addComponent(jLabel4)
				...
				.addGroup(
						panelHeaderLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addGroup(panelHeaderLayout.createSequentialGroup().addGap(12, 12, 12)
		...
		jPanel1Layout.setHorizontalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel1Layout.createSequentialGroup().addGap(89, 89, 89).addComponent(jLabel1)
		...
		jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel1Layout.createSequentialGroup().addContainerGap().addComponent(jLabel1)
						...
						.addGap(18, 18, 18).addComponent(btnChangePass).addGap(12, 12, 12).addComponent(btnLogout)
